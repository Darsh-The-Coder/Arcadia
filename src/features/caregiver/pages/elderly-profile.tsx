...
import { EditableProfileField } from '@/features/caregiver/components/profile/editable-profile-field';
import { EditableTagList } from '@/features/caregiver/components/profile/editable-tag-list';
import { useCareData } from '@/features/caregiver/state/care-context';
import type { DementiaStage } from '@/features/caregiver/types/care';
...
export default function ElderlyProfilePage() {
  ...
  return (
    <DetailScreenShell>
      ...
      <DetailScreenBody>
        <section className="flex items-center gap-4 rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
          ...
          <div className="min-w-0">
            <p className="font-serif text-2xl text-[var(--foreground)]">{elderly.name}</p>
            <p className="text-sm text-[var(--muted-foreground)]">Age {elderly.age}</p>
          </div>
        </section>
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-4">
          <p className="text-xs font-bold uppercase tracking-wide text-[var(--muted-foreground)]">Allergies</p>
          <div className="mt-2">
            <EditableTagList
