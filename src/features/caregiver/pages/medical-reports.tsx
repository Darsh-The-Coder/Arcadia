...
import { MedicalInfoRow } from '@/features/caregiver/components/medical/medical-info-row';
import { MedicalInfoFormDialog } from '@/features/caregiver/components/medical/medical-info-form-dialog';
import { MedicalRecordItem } from '@/features/caregiver/components/medical/medical-record-item';
import { MedicalRecordFormDialog, type MedicalRecordFormValues } from '@/features/caregiver/components/medical/medical-record-form-dialog';
      ...
      <DetailScreenBody>
        <section>
          <div className="flex items-center justify-between">
            <h2 className="font-serif text-lg text-[var(--foreground)]">Medical Information</h2>
        ...
        <section>
          <div className="flex items-center justify-between">
            <h2 className="font-serif text-lg text-[var(--foreground)]">Medical Records</h2>
          ...
          <div className="mt-3 space-y-2">
            {chronologicalRecords.length > 0 ? (
              ...
              <p className="text-sm text-[var(--muted-foreground)]">No records yet.</p>
            )}
          </div>
        </section>
      </DetailScreenBody>
