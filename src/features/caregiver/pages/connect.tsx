...
import { ContactCard } from '@/features/caregiver/components/contacts/contact-card';
import { ContactFormDialog, type ContactFormValues } from '@/features/caregiver/components/contacts/contact-form-dialog';
...
import type { ContactCategory } from '@/features/caregiver/types/care';
          ...
          return (
            <section key={category}>
              <div className="flex items-center justify-between">
                <h2 className="text-xs font-bold uppercase tracking-wide text-[var(--muted-foreground)]">{title}</h2>
                <button
              ...
              <div className="mt-2 space-y-2">
                {contacts.length > 0 ? (
                  ...
                  <p className="text-sm text-[var(--muted-foreground)]">No {title.toLowerCase()} added yet.</p>
                )}
              </div>
            </section>
          );
